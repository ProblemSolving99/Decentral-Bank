...
class App extends Component {
    ...
    async loadBlockchainData() {
        ...
        if (tetherDataAbi && rwdDataAbi && decentralBankDataAbi) {
            ...
            const stakingBalance = (await decentralBank.methods.stakingBalance(decentralBankDataAbi.address).call());
            console.log(stakingBalance);
            //TODO CHECK WHY RWD BALANCE IS 0 AND HOW TO GET STAKINBALANCE OF DECENTRAL BANK.
            
            this.setState({ ...this.state, address: account[0], tether, tetherBalance, rwd, rwdBalance, decentralBank, stakingBalance });
    ...
    render() {
        return (
            <div>
                ...
                <Navbar address={this.state.address}></Navbar>
            </div>
        );
    }
}
